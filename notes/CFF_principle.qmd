...
```{=html}
<iframe style="width:100%; height:400px; overflow: hidden" scrolling="no" src="../frames/index.html"></iframe>
```
...
<div>
```{=html}
<video autoplay loop class="video-embed" src="https://github.com/edibotopic/proFracLab/raw/master/vids/low_viscosity.mp4"></video>
```
</div>
...
<div>
```{=html}
<video autoplay loop class="video-embed" src="https://github.com/edibotopic/proFracLab/raw/master/vids/high_viscosity.mp4"></iframe>
```
</div>
